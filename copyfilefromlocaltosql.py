...
def file_movement_flow():
    ...
    file_data = read_csv(r"C:\Users\MK2307\OneDrive - Modak Analytics LLP\MY MODAK WORK\HUMANA PROJECT\PREFECT\MYFILE.csv")  # Read CSV file and store data in file_data
